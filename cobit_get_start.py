            ...
            if ret:
                if a.get_cv_mode() == 0:  # normal video display
                    ...
                    if img_angle is None:
                        print(">> Can not get lane image and angle!!")
                        pass
                    else:
                        print(angle_deep)
...
class App(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("DeepThinkCar Operation Demo")
    ...
    def test_servo_motor(self):
        ...
        for i in range(3):
            ...
            time.sleep(1)
            self.servo.servo[0].angle = 90
        print(">> Servo motor testing is completed!")
    ...
    def opencv_lane_drive_start(self):
        ...
        print(">> Start driving using OpenCV...")
    ...
    def opencv_lane_drive_stop(self):
        ...
        self.radio_normal.setChecked(True)
        self.cv_mode = 0
        print(">> Stop driving using OpenCV...")
    ...
    def deep_lane_drive_start(self):
        ...
        print(">> Start driving using deep learning...")
    ...
    def deep_lane_drive_stop(self):
        ...
        self.radio_deep_steering.setChecked(False)
        self.radio_normal.setChecked(True)
        print(">> Stop driving using deep learning...")     
